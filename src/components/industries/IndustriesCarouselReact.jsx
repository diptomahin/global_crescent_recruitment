...
export default function IndustriesCarouselReact() {
  ...
  return (
    <section className="bg-[linear-gradient(180deg,#f4efea_0%,#ffffff_100%)] py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {highlights.map((item, index) => (
            ...
            >
              <div className="mb-6 h-24 rounded-2xl bg-[radial-gradient(circle_at_top_left,_rgba(214,0,0,0.5),_transparent_40%),linear-gradient(135deg,#242424_0%,#121212_100%)]" />
