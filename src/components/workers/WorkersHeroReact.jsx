...
export default function WorkersHeroReact() {
  ...
  return (
    <section className="relative min-h-screen pt-24 overflow-hidden bg-[radial-gradient(circle_at_20%_10%,_rgba(214,0,0,0.2),_transparent_22%),radial-gradient(circle_at_80%_18%,_rgba(0,176,116,0.18),_transparent_18%),linear-gradient(135deg,#080808_0%,#121212_50%,#16261e_100%)] flex items-center text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[1.04fr_0.96fr] lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2" data-aos="fade-left">
          <div className="rounded-[28px] border border-white/10 bg-white/10 p-6 backdrop-blur-xl shadow-[0_18px_50px_rgba(0,0,0,0.28)]">
            <p className="text-4xl font-bold text-white"><CountUpNumber end={25} suffix="+" /></p>
            <p className="mt-2 text-white/80">Active destination markets and placement regions.</p>
          </div>
          <div className="rounded-[28px] border border-white/10 bg-white/10 p-6 backdrop-blur-xl shadow-[0_18px_50px_rgba(0,0,0,0.28)]">
            <p className="text-4xl font-bold text-white"><CountUpNumber end={50} suffix="+" /></p>
